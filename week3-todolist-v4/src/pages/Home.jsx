...
function Home() {
    ...
    useEffect(() => {
        ...
        console.log("렌더링 input:", text);

    }, [text]);

    useEffect(() => {

        console.log("localStorage 저장 실행");
        ...
        <div className="w-full max-w-2xl mx-auto bg-white rounded-[36px] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
            ...
            <div className="bg-[#F7F8FE] rounded-[28px] p-6 mt-6">
                ...
                <div className="mb-6">
                    ...
                    <button
                        onClick={addTodo}
                        className="w-full bg-[#7C86FF] text-white py-4 rounded-2xl font-bold shadow-md"
                    >
                        추가하기
                    </button>
                ...
                <div className="flex gap-3 mb-5">
                    ...
                    <button
                        ...
                        className="flex-1 bg-white py-3 rounded-2xl text-gray-600 font-semibold shadow-sm"
                    >
                        전체
                    </button>
